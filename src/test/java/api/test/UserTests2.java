...
public class UserTests2 {
	...
	public void testGetuserByName() {
		...
		Response response = UserEndPoints2.getUer(this.userPayload.getUsername());
		response.then().log().all();
		Assert.assertEquals(response.getStatusCode(),200);
	...
	public void testUpdateUserByName() {
		...
		Response responseAfterUpdate = UserEndPoints2.getUer(this.userPayload.getUsername());
	...
	public void testDeleteByName() {
		...
		Response response = UserEndPoints2.deleteUer(this.userPayload.getUsername());
